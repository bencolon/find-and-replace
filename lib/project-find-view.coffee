...
class ProjectFindView extends View
  ...
  showResultPane: ->
    ...
    options.split = atom.config.get('find-and-replace.openProjectFindResultsInANewPane') if atom.config.get('find-and-replace.openProjectFindResultsInANewPane') != 'no'
    debugger;
